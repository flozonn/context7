...
[![Add to Kiro](https://img.shields.io/badge/Kiro-Add_to_Kiro?style=flat-square&label=Context7%20MCP&color=7B61FF)](kiro://kiro.mcp/add?name=context7&config=%7B%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22%40upstash%2Fcontext7-mcp%22%5D%2C%22disabled%22%3Afalse%2C%22autoApprove%22%3A%5B%5D%7D)

You can also visit the [Kiro MCP Server Catalog](https://kiro.dev/docs/mcp/servers/) and click the **+ Add to Kiro** button for Context7.
